...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnCancelar,
      @NonNull Button btnSendPrint, @NonNull EditText etLecturaP, @NonNull Spinner spObsP,
      @NonNull Switch swNmedP, @NonNull TextView textView4, @NonNull TextView textView5,
      @NonNull TextView textView6, @NonNull TextView tvDescCodigoP,
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, btnCancelar, btnSendPrint,
